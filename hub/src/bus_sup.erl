...
init(#{bind_host := Host, port := Port}) ->
    ...
    Dispatch = cowboy_router:compile([
        {'_', [
            ...
            {"/dashboard/operator-events.js", bus_dashboard_h, operator_events},
            {"/dashboard/console-view.js", bus_dashboard_h, console},
            {"/dashboard/operator-work.js", bus_dashboard_h, operator_work},
            {"/dashboard/operator-actions.js", bus_dashboard_h, operator_actions},
            ...
            {"/dashboard/api/v1/stream", bus_operator_stream_h, []},
            {"/dashboard/api/v1/search", bus_operator_h, search},
            {"/dashboard/api/v1/work", bus_operator_h, work_fleet},
            {"/dashboard/api/v1/work/:agent_id", bus_operator_h, work},
            {"/dashboard/api/v1/operations", bus_operator_h, operations},
            {"/dashboard/api/v1/operations/:operation_id/cancel", bus_operator_h, operation_cancel},
            {"/dashboard/api/v1/operations/:operation_id", bus_operator_h, operation_status},
            {"/dashboard/api/v1/channels", bus_operator_h, channels},
            {"/dashboard/api/v1/channels/:name/messages", bus_operator_h, channel_messages},
            {"/dashboard/api/v1/channels/:name/status", bus_operator_h, channel_status},
            {"/v1/agents", bus_http_h, list},
            {"/v1/agents/:agent_id", bus_http_h, agent},
            {"/v1/messages", bus_http_h, messages},
            {"/v1/channels", bus_channels_h, list},
            {"/v1/channels/:name/messages", bus_channels_h, messages},
            {"/v1/channels/:name/status", bus_channels_h, status},
            {"/v1/channels/:name", bus_channels_h, channel},
            {"/v1/events", bus_events_h, []},
            {"/v1/operator/announce", bus_operator_native_h, announce},
            {"/v1/operator/requests", bus_operator_native_h, requests},
            {"/v1/operator/content", bus_operator_native_h, content},
            {"/v1/operator/results", bus_operator_native_h, results},
            {"/v1/operator/activity", bus_operator_native_h, activity}
        ]}
    ]),
    TransOpts = #{
        logger => bus_log,
